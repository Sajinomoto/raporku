...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0B0F19] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-fuchsia-600/10 rounded-full blur-3xl -z-10"></div>

      {/* Login Card */}
      <div className="w-full max-w-md bg-[#0F172A]/80 backdrop-blur-md border border-[#1E293B] rounded-2xl p-8 shadow-2xl space-y-8 relative">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-white tracking-wide mt-3">Raporku Eduscore</h1>
          <p className="text-xs text-zinc-400 max-w-[280px]">
            Sistem e-rapor dashboard interaktif untuk pendidik dan staf akademik.
          </p>
        </div>

        {/* Error Notification */}
        {errorMsg && (
          <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-xl text-red-400 text-xs flex items-start gap-2.5">
        ...
        <div className="space-y-4 pt-2">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-5 py-3.5 bg-white hover:bg-zinc-100 text-zinc-900 rounded-xl font-bold text-sm transition-all shadow-lg hover:shadow-xl active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
          >
            {loading ? (
